...
public class LogrosService {
    ...
    private static final List<Logro> LOGROS=List.of(
            ...
            new Logro("sort-primera","Primer escaparate","Completa tu primer nivel de PokéSort.","🛍️","Fácil",10,"pokesort-victorias",1,false),
            new Logro("sort-cinco","Estantes impecables","Completa cinco partidas de PokéSort.","📦","Media",30,"pokesort-victorias",5,false),
            new Logro("sort-nivel-cinco","Dependiente experto","Supera el nivel 5 de PokéSort.","🧸","Media",30,"pokesort-nivel",5,false),
            new Logro("sort-nivel-diez","Tienda sin secretos","Supera el nivel 10 de PokéSort.","🔑","Difícil",75,"pokesort-nivel",10,false),
            new Logro("sort-nivel-veinte","Dueño de la tienda","Supera los 20 niveles de PokéSort.","🏬","Legendaria",200,"pokesort-nivel",20,false),
    ...
    private static final List<Premio> PREMIOS=List.of(
            ...
            new Premio("avatar-pokesort-rowlet","Avatar Rowlet de PokéSort","Un compañero de tienda para tu perfil de entrenador.","🧸",250,"avatar",722),
